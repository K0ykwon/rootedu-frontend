      ...
      <div className="space-y-6">
        ...
        <Card className="bg-gradient-to-br from-blue-900/50 to-purple-900/50 border-blue-500/30">
          <div className="text-center py-6">
            <h2 className="text-2xl font-bold text-white mb-2">📝 수능 어휘 마스터 챌린지</h2>
            <p className="text-blue-100">KICE 필수 어휘 150개 중 랜덤 15개</p>
          </div>
        </Card>
        ...
        {currentStep === 0 && (
          <Card className="bg-gray-800 dark:bg-gray-900 border-gray-700">
            <div className="p-6">
              <h2 className="text-xl font-bold text-white mb-4 text-center">🎯 오늘의 어휘 15개</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                {vocabList.map((word, index) => (
                  <div key={index} className="bg-gray-700 p-4 rounded-lg">
                    <h3 className="text-lg font-bold text-white mb-2">{word.word}</h3>
                    <p className="text-gray-300 text-sm mb-2">{word.meaning}</p>
                    <div className="flex gap-2">
                      <span className="px-2 py-1 bg-blue-600/20 text-blue-300 text-xs rounded-full">{word.level}</span>
                      <span className="px-2 py-1 bg-purple-600/20 text-purple-300 text-xs rounded-full">{word.category}</span>
                    </div>
                  </div>
                ))}
              </div>
        ...
        {isLoading && (
          <Card className="bg-gray-800 dark:bg-gray-900 border-gray-700">
            <div className="p-8 text-center">
              ...
              <h2 className="text-xl font-bold text-white mb-2">퀴즈를 생성하고 있습니다...</h2>
            ...
            <div className="p-6">
              ...
              {currentQuizType === 'basic' && (
                <div>
                  ...
                  <div className="text-center">
                    <div className="mb-6">
                      <h3 className="text-2xl font-bold text-white mb-2">{currentQuizData?.word.meaning}</h3>
                      <span className="px-3 py-1 bg-blue-600/20 text-blue-300 text-sm rounded-full">{currentQuizData?.word.level}</span>
                    </div>
                    
                    <div className="max-w-2xl mx-auto">
                      {!showAnswer ? (
                        <div className="space-y-4">
                          <h4 className="text-lg text-gray-300 mb-4">이 뜻에 해당하는 단어를 선택하세요:</h4>
                        ...
                        <div className="space-y-4">
                          <div className={`p-4 rounded-lg ${isCorrect ? 'bg-green-900/50 border-green-500' : 'bg-red-900/50 border-red-500'}`}>
                          ...
                          <div className="p-4 bg-gray-700 rounded-lg">
                            <h4 className="text-white font-semibold mb-2">📝 예문</h4>
                            <p className="text-gray-300">"{currentQuizData?.word.example}"</p>
                          </div>
              ...
              {currentQuizType === 'blank' && (
                <div>
                  ...
                  <div className="text-center">
                    <h3 className="text-xl font-bold text-white mb-4">📝 빈칸에 들어갈 단어를 선택하세요</h3>
                    <p className="text-gray-300 mb-6 text-lg">{currentQuizData?.sentence}</p>
        ...
        {quizCompleted && (
          <Card className="bg-gray-800 dark:bg-gray-900 border-gray-700">
            <div className="p-6 text-center">
              ...
              <p className="text-gray-300 mb-6">수고하셨습니다!</p>
              
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="bg-gray-700 p-4 rounded-lg">
                  <div className="text-3xl font-bold text-green-400">{score}</div>
                  <div className="text-gray-300">정답</div>
                </div>
                <div className="bg-gray-700 p-4 rounded-lg">
                  <div className="text-3xl font-bold text-red-400">{15 - score}</div>
                  <div className="text-gray-300">오답</div>
                </div>
                <div className="bg-gray-700 p-4 rounded-lg">
                  <div className="text-3xl font-bold text-blue-400">{Math.round((score / 15) * 100)}%</div>
              ...
              {wrongWords.length > 0 && (
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-white mb-4">❌ 틀린 단어들 ({wrongWords.length}개)</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {wrongWords.map((word, index) => (
                      <div key={index} className="bg-gray-700 p-3 rounded-lg text-left">
                        <h5 className="text-white font-semibold">{word.word}</h5>
                        <p className="text-gray-300 text-sm">{word.meaning}</p>
                        <p className="text-gray-400 text-xs">"{word.example}"</p>
                      </div>
                    ))}
                  </div>
                </div>
    ...
    return (
      <div className="space-y-6">
        ...
        <Card className="bg-gradient-to-br from-purple-900/50 to-blue-900/50 border-purple-500/30">
          <div className="text-center py-6">
            <h2 className="text-2xl font-bold text-white mb-2">🎯 파생 문제 생성</h2>
            <p className="text-purple-100">지문을 바탕으로 한 수능 스타일 문제 3개</p>
          </div>
        </Card>
        ...
        <Card className="bg-gray-800 dark:bg-gray-900 border-gray-700">
          <div className="p-6">
            <div className="mb-4">
              <h3 className="text-xl font-bold text-white mb-2">{currentText?.title}</h3>
              <div className="flex gap-4 text-sm text-gray-400">
                <span className="px-2 py-1 bg-purple-600/20 text-purple-300 rounded-full">{currentText?.category}</span>
                <span className="px-2 py-1 bg-blue-600/20 text-blue-300 rounded-full">{currentText?.word_count}자</span>
              </div>
            </div>
              ...
              <div className="space-y-6">
                ...
                {showQuestionAnswer && (
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-gray-700 rounded-lg">
                      <h4 className="text-white font-semibold mb-2">정답: {String.fromCharCode(65 + currentQuestion.correctAnswer)}. {currentQuestion.options[currentQuestion.correctAnswer]}</h4>
        ...
        {questionCompleted && (
          <Card className="bg-gray-800 dark:bg-gray-900 border-gray-700">
            <div className="p-6 text-center">
              <h3 className="text-2xl font-bold text-white mb-4">🎉 파생 문제 완료!</h3>
              <p className="text-gray-300 mb-6">수고하셨습니다!</p>
              
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="bg-gray-700 p-4 rounded-lg">
                  <div className="text-3xl font-bold text-green-400">{questionScore}</div>
                  <div className="text-gray-300">정답</div>
                </div>
                <div className="bg-gray-700 p-4 rounded-lg">
                  <div className="text-3xl font-bold text-red-400">{3 - questionScore}</div>
                  <div className="text-gray-300">오답</div>
                </div>
                <div className="bg-gray-700 p-4 rounded-lg">
                  <div className="text-3xl font-bold text-purple-400">{Math.round((questionScore / 3) * 100)}%</div>
                  <div className="text-gray-300">정답률</div>
                </div>
              </div>
    ...
    return (
      <div className="space-y-6">
        ...
        <Card className="bg-gradient-to-br from-orange-900/50 to-red-900/50 border-orange-500/30">
          <div className="text-center py-6">
            <h2 className="text-2xl font-bold text-white mb-2">① '문맥 파악' 스킬업</h2>
            <p className="text-orange-100">▼ 문해력 향상 챌린지</p>
          </div>
        </Card>
        ...
        <Card className="bg-gray-800 dark:bg-gray-900 border-gray-700">
          <div className="p-6">
            <div className="mb-4">
              <h2 className="text-xl font-bold text-white mb-2">{currentText.title}</h2>
              <div className="flex gap-4 text-sm text-gray-400">
                <span className="px-2 py-1 bg-orange-600/20 text-orange-300 rounded-full">{currentText.category}</span>
                <span className="px-2 py-1 bg-blue-600/20 text-blue-300 rounded-full">{currentText.word_count}자</span>
              </div>
            </div>
            <div className="text-gray-300 leading-relaxed">
        ...
        {!showResults && (
          <Card className="bg-gray-800 dark:bg-gray-900 border-gray-700">
            <div className="p-6">
              <h3 className="text-xl font-bold text-white mb-4">📝 지문을 한 문장으로 요약해보세요</h3>
              <div className="space-y-4">
                <textarea
                  value={userSummary}
                  onChange={(e) => setUserSummary(e.target.value)}
                  placeholder="지문의 핵심 내용을 한 문장으로 요약해주세요..."
                  className="w-full px-4 py-3 rounded-lg bg-gray-700 text-white border border-gray-600 focus:border-orange-500 focus:outline-none"
                  rows={4}
                />
        ...
        {showResults && (
          <div className="space-y-6">
            ...
            <Card className="bg-gray-800 dark:bg-gray-900 border-gray-700">
              <div className="p-6">
                <h4 className="text-lg font-semibold text-white mb-3">📝 당신의 요약</h4>
            ...
            <Card className="bg-gray-800 dark:bg-gray-900 border-gray-700">
              <div className="p-6">
                <h4 className="text-lg font-semibold text-white mb-3">🤖 AI 피드백</h4>
            ...
            <Card className="bg-gray-800 dark:bg-gray-900 border-gray-700">
              <div className="p-6">
                <h4 className="text-lg font-semibold text-white mb-3">✨ 보완한 요약문 제안</h4>
                <p className="text-gray-300">{improvedSummary}</p>
              </div>
            </Card>
            ...
            <Card className="bg-gray-800 dark:bg-gray-900 border-gray-700">
              <div className="p-6">
                <h4 className="text-lg font-semibold text-white mb-3">💡 개선 포인트</h4>
                <p className="text-gray-300">이렇게 하면 단순히 핵심 내용만 나열하지 않고, 지문이 강조하는 갈등 구조와 가치 논의까지 담을 수 있어요.</p>
              </div>
            </Card>
    ...
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-br from-red-900/50 to-orange-900/50 border-red-500/30">
        <div className="text-center py-8">
          ...
          <h2 className="text-2xl font-bold text-white mb-3">길품국어 AI 학습 도구</h2>
          <p className="text-red-100 max-w-2xl mx-auto mb-4">
            고려대 국어국문학과 길품국어쌤과<br />
            <span className="font-semibold text-yellow-300">수능국어 능력치 UP!</span>
          </p>
          <p className="text-red-200 text-sm mb-6">
            • 길품쌤과 수능업!, 국어 파헤치고 등급업!
          </p>
          <div className="flex flex-wrap justify-center gap-2">
            <Badge variant="success" size="sm" className="bg-green-600 text-white">무료 제공</Badge>
            <Badge variant="primary" size="sm" className="bg-blue-600 text-white">AI 자동 생성</Badge>
            <Badge variant="warning" size="sm" className="bg-yellow-600 text-white">고려대 전문</Badge>
          </div>
        </div>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* 어휘 암기 챌린지 카드 */}
        <Card className="bg-gray-800 dark:bg-gray-900 border-gray-700 hover:shadow-lg transition-all duration-300">
          <div className="p-6">
            <div className="text-center mb-4">
              ...
              <h3 className="text-lg font-bold text-white mb-2">어휘 암기 챌린지</h3>
              <p className="text-gray-300 text-sm">
                수능 필수 어휘를 퀴즈로 재미있게 학습해보세요
              </p>
            </div>
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="px-2 py-1 bg-blue-600/20 text-blue-300 text-xs rounded-full">빈칸 채우기</span>
              <span className="px-2 py-1 bg-purple-600/20 text-purple-300 text-xs rounded-full">뜻 맞추기</span>
              <span className="px-2 py-1 bg-green-600/20 text-green-300 text-xs rounded-full">문맥 이해</span>
            </div>
            <Button 
              onClick={() => {
        ...
        <Card className="bg-gray-800 dark:bg-gray-900 border-gray-700 hover:shadow-lg transition-all duration-300">
          <div className="p-6">
            <div className="text-center mb-4">
              ...
              <h3 className="text-lg font-bold text-white mb-2">문맥 파악 스킬업</h3>
              <p className="text-gray-300 text-sm">
                문해력 향상을 위한 체계적인 훈련 프로그램
              </p>
            </div>
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="px-2 py-1 bg-orange-600/20 text-orange-300 text-xs rounded-full">문단 분석</span>
              <span className="px-2 py-1 bg-red-600/20 text-red-300 text-xs rounded-full">논리 구조</span>
              <span className="px-2 py-1 bg-yellow-600/20 text-yellow-300 text-xs rounded-full">핵심 파악</span>
            </div>
            <Button 
      ...
      <Card className="bg-gradient-to-r from-gray-800 to-gray-900 border-gray-700">
        <div className="p-6 text-center">
          <h4 className="text-lg font-semibold text-white mb-3">🎓 길품국어쌤의 특별한 AI 학습 시스템</h4>
